class Strings {
  ...
  static String hintEmail = "E-Posta Adresi";
  static String hintName = "Ad";
  static String hintSurname = "Soyad";
  static String hintPhoneNumber = "Telefon Numarası";
  static String hintPassword = "Şifre";
  static String hintConfirmPassword = "Şifre Onayı";
  ...
  static String notificationsDes =
      "Bildirimlerden haberdar olmak için sık sık kontrol et.";
  ...
  static String splashScreenTitle1 = "En İyi Fiyat Garantisi";
  static String splashScreenTitle2 = "Online İptal ve Değişiklik";
  static String splashScreenTitle3 = "Fırsatları Kaçırma";
  static String splashScreenDescription1 =
      "Biletini, tüm feribot seferlerini karşılaştırarak en iyi fiyat garantisi ile satın alabilirsin.";
  static String splashScreenDescription2 =
